...
{
    public partial class Uc_VirtualFan : VirtualDevice
    {
        public Uc_VirtualFan()
        {
            InitializeComponent();
        }
        ...
        private void OnLoad(object sender, EventArgs e)
        {
            ...
            var keycaps = Helpers.LedKeyHelper.GetAllKeysForDevice(RGBDeviceType.Fan);
            ...
            if (keycaps != null)
            {
                foreach (var key in keycaps)
                {
                    ...
                    var keycap = new KeyButton
                    {
                        ...
                        Dock = DockStyle.Fill,
                        Text = key.Value.ToString().Replace("Fan", ""),
