...
{
    public partial class Uc_VirtualGraphicsCard : VirtualDevice
    {
        public Uc_VirtualGraphicsCard()
        {
            InitializeComponent();
        }
        ...
        private void OnLoad(object sender, EventArgs e)
        {
            ...
            var keycaps = Helpers.LedKeyHelper.GetAllKeysForDevice(RGBDeviceType.GraphicsCard);
            ...
            if (keycaps != null)
            {
                foreach (var key in keycaps)
                {
                    ...
                    var keycap = new KeyButton
                    {
                        ...
                        Dock = DockStyle.Fill,
                        Text = key.Value.ToString().Replace("GraphicsCard", ""),
