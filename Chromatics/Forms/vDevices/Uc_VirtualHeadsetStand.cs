...
{
    public partial class Uc_VirtualHeadsetStand : VirtualDevice
    {
        public Uc_VirtualHeadsetStand()
        {
            InitializeComponent();
        }
        ...
        private void OnLoad(object sender, EventArgs e)
        {
            ...
            var keycaps = Helpers.LedKeyHelper.GetAllKeysForDevice(RGBDeviceType.HeadsetStand);
            ...
            if (keycaps != null)
            {
                foreach (var key in keycaps)
                {
                    ...
                    var keycap = new KeyButton
                    {
                        ...
                        Dock = DockStyle.Fill,
                        Text = key.Value.ToString().Replace("HeadsetStand", ""),
