...
{
    public partial class Uc_VirtualCooler : VirtualDevice
    {
        public Uc_VirtualCooler()
        {
            InitializeComponent();
        }
        ...
        private void OnLoad(object sender, EventArgs e)
        {
            ...
            var keycaps = Helpers.LedKeyHelper.GetAllKeysForDevice(RGBDeviceType.Cooler);
            ...
            if (keycaps != null)
            {
                foreach (var key in keycaps)
                {
                    ...
                    var keycap = new KeyButton
                    {
                        ...
                        Dock = DockStyle.Fill,
                        Text = key.Value.ToString().Replace("Cooler", ""),
