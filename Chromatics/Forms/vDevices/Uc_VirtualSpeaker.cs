...
{
    public partial class Uc_VirtualSpeaker : VirtualDevice
    {
        public Uc_VirtualSpeaker()
        {
            InitializeComponent();
        }
        ...
        private void OnLoad(object sender, EventArgs e)
        {
            ...
            var keycaps = Helpers.LedKeyHelper.GetAllKeysForDevice(RGBDeviceType.Speaker);
            ...
            if (keycaps != null)
            {
                foreach (var key in keycaps)
                {
                    ...
                    var keycap = new KeyButton
                    {
                        ...
                        Dock = DockStyle.Fill,
                        Text = key.Item2.ToString().Replace("Speaker", ""),
