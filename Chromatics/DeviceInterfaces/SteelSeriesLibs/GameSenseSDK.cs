...
(handler ""COLOR""
    (lambda (data)
        ...
        (when (zone1:? data)
            (let* ((zone1 (zone1: data))
                    (color (color: zone1)))
                (on-device ""rgb-1-zone"" show-on-zone: color one:)
                (on-device ""rgb-2-zone"" show-on-zone: color one:)
                (on-device ""rgb-3-zone"" show-on-zone: color one:)
                (on-device ""rgb-4-zone"" show-on-zone: color one:)
                (on-device ""rgb-5-zone"" show-on-zone: color one:)))
        (when (zone2:? data)
            (let* ((zone2 (zone2: data))
                    (color (color: zone2)))
                (on-device ""rgb-1-zone"" show-on-zone: color two:)
                (on-device ""rgb-2-zone"" show-on-zone: color two:)
                (on-device ""rgb-3-zone"" show-on-zone: color two:)
                (on-device ""rgb-4-zone"" show-on-zone: color two:)
                (on-device ""rgb-5-zone"" show-on-zone: color two:)))
        (when (zone3:? data)
            (let* ((zone3 (zone3: data))
                    (color (color: zone3)))
                (on-device ""rgb-1-zone"" show-on-zone: color three:)
                (on-device ""rgb-2-zone"" show-on-zone: color three:)
                (on-device ""rgb-3-zone"" show-on-zone: color three:)
                (on-device ""rgb-4-zone"" show-on-zone: color three:)
                (on-device ""rgb-5-zone"" show-on-zone: color three:)))
        (when (zone4:? data)
            (let* ((zone4 (zone4: data))
                    (color (color: zone4)))
                (on-device ""rgb-1-zone"" show-on-zone: color four:)
                (on-device ""rgb-2-zone"" show-on-zone: color four:)
                (on-device ""rgb-3-zone"" show-on-zone: color four:)
                (on-device ""rgb-4-zone"" show-on-zone: color four:)
                (on-device ""rgb-5-zone"" show-on-zone: color four:)))
        (when (zone5:? data)
            (let* ((zone5 (zone5: data))
                    (color (color: zone5)))
                (on-device ""rgb-1-zone"" show-on-zone: color five:)
                (on-device ""rgb-2-zone"" show-on-zone: color five:)
                (on-device ""rgb-3-zone"" show-on-zone: color five:)
                (on-device ""rgb-4-zone"" show-on-zone: color five:)
                (on-device ""rgb-5-zone"" show-on-zone: color five:)))
        (when (periph:? data)
