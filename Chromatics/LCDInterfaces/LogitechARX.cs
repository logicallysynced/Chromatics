...
namespace Chromatics.LCDInterfaces
{
    ...
    public interface ILogitechArx
    {
        ...
        void ArxUpdateFfxivStats(double hp_percent, double mp_percent, double tp_percent, int hp_current, int mp_current,
            int tp_current, uint zone, string job, string hudmode, double target_percent, int target_hpcurrent, int target_hpmax, string target_name, int target_engaged);

        void ArxUpdateFfxivPlugin(double hp_percent, double mp_percent, double tp_percent, int hp_current, int mp_current,
            int tp_current, uint zone, string job, string hudmode, double target_percent, int target_hpcurrent, int target_hpmax, string target_name, int target_engaged, int hp_max, int mp_max, double playerposX, double playerposY, double playerposZ, Actor.ActionStatus actionstatus, double castperc, float castprogress, float casttime, bool castingtoggle, float hitboxrad, bool playerclaimed, Actor.Job playerjob, uint mapid, uint mapindex, uint mapterritory, string playername, Actor.TargetType targettype);
    ...
    public class LogitechArx : ILogitechArx
    {
        ...
        public bool InitializeArx()
        {
            ...
            try
            {
                ...
                var retVal = LogitechArxWrapper.LogiArxInit("chromatics", "Chromatics - Final Fantasy XIV", ref contextCallback);
                if (!retVal)
                {
        ...
        private static void SdkCallback(int eventType, int eventValue, string eventArg, System.IntPtr context)
        {
            switch (eventType)
            {
                case LogitechArxWrapper.LOGI_ARX_EVENT_MOBILEDEVICE_ARRIVAL:
                    ...
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/libs/jquery/jquery/dist/jquery.js", "libs/jquery/jquery/dist/jquery.js", "text/javascript");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/libs/jquery/tether/dist/js/tether.min.js", "libs/jquery/tether/dist/js/tether.min.js", "text/javascript");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/libs/jquery/bootstrap/dist/js/bootstrap.js", "libs/jquery/bootstrap/dist/js/bootstrap.js", "text/javascript");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/libs/jquery/underscore/underscore-min.js", "libs/jquery/underscore/underscore-min.js", "text/javascript");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/libs/jquery/jQuery-Storage-API/jquery.storageapi.min.js", "libs/jquery/jQuery-Storage-API/jquery.storageapi.min.js", "text/javascript");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/libs/jquery/PACE/pace.min.js", "libs/jquery/PACE/pace.min.js", "text/javascript");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/scripts/ui-form.js", "scripts/ui-form.js", "text/javascript");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/scripts/ffxivdata.js", "scripts/ffxivdata.js", "text/javascript");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/scripts/chromatics.js", "scripts/chromatics.js", "text/javascript");
                    

                    //Load CSS
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/assets/animate.css/animate.min.css", "assets/animate.css/animate.min.css", "text/css");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/assets/glyphicons/glyphicons.css", "assets/glyphicons/glyphicons.css", "text/css");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/assets/font-awesome/css/font-awesome.min.css", "assets/font-awesome/css/font-awesome.min.css", "text/css");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/assets/material-design-icons/material-design-icons.css", "assets/material-design-icons/material-design-icons.css", "text/css");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/assets/bootstrap/dist/css/bootstrap.min.css", "assets/bootstrap/dist/css/bootstrap.min.css", "text/css");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/assets/styles/app.css", "assets/styles/app.css", "text/css");
                    LogitechArxWrapper.LogiArxAddFileAs(webdir + "/assets/styles/font.css", "assets/styles/font.css", "text/css");
        ...
        {
            List<string> pluginsdata = new List<string>();
                ...
                foreach (var plugin in pluginSearch)
                {
                    using (var sr = new StreamReader(plugin))
                    {
                        try
                        {
                            ...
                            var plugincss = Directory.GetFiles(resourcedir + @"\css\", "*.css", SearchOption.AllDirectories);
                            var pluginjs = Directory.GetFiles(resourcedir + @"\js\", "*.js", SearchOption.AllDirectories);
                            var pluginimgPNG = Directory.GetFiles(resourcedir + @"\img\", "*.png", SearchOption.AllDirectories);
                            var pluginimgJPG = Directory.GetFiles(resourcedir + @"\img\", "*.jpg", SearchOption.AllDirectories);
                            var pluginimgGIF = Directory.GetFiles(resourcedir + @"\img\", "*.gif", SearchOption.AllDirectories);
                            ...
                            LogitechArxWrapper.LogiArxAddFileAs("core/scripts/ffxivsetup.js", "ffxivsetup.js", "text/javascript");
                            LogitechArxWrapper.LogiArxAddFileAs("core/scripts/ffxivexternal.js", "ffxivexternal.js", "text/javascript");
        ...
        public void ArxUpdateFfxivStats(double hp_percent, double mp_percent, double tp_percent, int hp_current, int mp_current,
            int tp_current, uint zone, string job, string hudmode, double target_percent, int target_hpcurrent, int target_hpmax, string target_name, int target_engaged)
        {
            ...
            LogitechArxWrapper.LogiArxSetTagContentById("current_location", _ffxivMapIds.ContainsKey(zone) ? _ffxivMapIds[zone] : "");
        ...
        public void ArxUpdateFfxivPlugin(double hp_percent, double mp_percent, double tp_percent, int hp_current, int mp_current,
            int tp_current, uint zone, string job, string hudmode, double target_percent, int target_hpcurrent, int target_hpmax, string target_name, int target_engaged, int hp_max, int mp_max, double playerposX, double playerposY, double playerposZ, Actor.ActionStatus actionstatus, double castperc, float castprogress, float casttime, bool castingtoggle, float hitboxrad, bool playerclaimed, Actor.Job playerjob, uint mapid, uint mapindex, uint mapterritory, string playername, Actor.TargetType targettype)
        {
            LogitechArxWrapper.LogiArxSetTagContentById("hp_percent", hp_percent.ToString("#0%"));
            LogitechArxWrapper.LogiArxSetTagContentById("mp_percent", mp_percent.ToString("#0%"));
        ...
        public void ArxUpdateFfxivParty(string p1data, string p2data, string p3data, string p4data, string p5data, string p6data, string p7data, string p8data, string p9data)
        {
