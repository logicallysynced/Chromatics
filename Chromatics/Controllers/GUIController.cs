...
namespace Chromatics
{
    partial class Chromatics : ILogWrite
    {
        ...
        private readonly Dictionary<string, string[]> _mappingPalette = new Dictionary<string, string[]>
        {
            ...
            {"ColorMappingJobSGENegative", new[] { "SGE: Blank Key", "9", "Black", "White"}},
            {"ColorMappingJobSGEAddersgallStacks", new[] { "SGE: Addersgall Stacks", "9", "Black", "White"}},
            {"ColorMappingJobSGEEukrasiaActive", new[] { "SGE: Eukrasia Active", "9", "Black", "White"}},
            {"ColorMappingJobSGEAddersgallRecharge", new[] { "SGE: Addersgall Recharge", "9", "Black", "White"}},
            {"ColorMappingJobRPRNegative", new[] { "RPR: Blank Key", "9", "Black", "White"}},
            {"ColorMappingJobRPRSouls", new[] { "RPR: Souls Collected", "9", "Black", "White"}},
            {"ColorMappingJobRPRShrouds", new[] { "RPR: Shrouds Collected", "9", "Black", "White"}},
