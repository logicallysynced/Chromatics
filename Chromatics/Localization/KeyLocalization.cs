...
namespace Chromatics.Localization
{
    public static class KeyLocalization
    {
        ...
        public static Dictionary<LedId, int[]> QWERTY_Grid = new Dictionary<LedId, int[]>() //row, column
        {
            ...
            { LedId.Keyboard_F1, new int[] { 0, 2 } },
            { LedId.Keyboard_F2, new int[] { 0, 3 } },
            { LedId.Keyboard_F3, new int[] { 0, 4 } },
            { LedId.Keyboard_F4, new int[] { 0, 5 } },
            { LedId.Keyboard_F5, new int[] { 0, 7 } },
            { LedId.Keyboard_F6, new int[] { 0, 8 } },
            { LedId.Keyboard_F7, new int[] { 0, 9 } },
            { LedId.Keyboard_F8, new int[] { 0, 10 } },
            { LedId.Keyboard_F9, new int[] { 0, 12 } },
            { LedId.Keyboard_F10, new int[] { 0, 13 } },
            { LedId.Keyboard_F11, new int[] { 0, 14 } },
            { LedId.Keyboard_F12, new int[] { 0, 15 } },
            { LedId.Keyboard_PrintScreen, new int[] { 0, 16 } },
            { LedId.Keyboard_ScrollLock, new int[] { 0, 17 } },
            { LedId.Keyboard_PauseBreak, new int[] { 0, 18 } },

            { LedId.Keyboard_GraveAccentAndTilde, new int[] { 1, 0 } },
            { LedId.Keyboard_1, new int[] { 1, 1 } },
            { LedId.Keyboard_2, new int[] { 1, 2 } },
            { LedId.Keyboard_3, new int[] { 1, 3 } },
            { LedId.Keyboard_4, new int[] { 1, 4 } },
            { LedId.Keyboard_5, new int[] { 1, 5 } },
            { LedId.Keyboard_6, new int[] { 1, 6 } },
            { LedId.Keyboard_7, new int[] { 1, 7 } },
            { LedId.Keyboard_8, new int[] { 1, 8 } },
            { LedId.Keyboard_9, new int[] { 1, 9 } },
            { LedId.Keyboard_0, new int[] { 1, 10 } },
            { LedId.Keyboard_MinusAndUnderscore, new int[] { 1, 11 } },
            { LedId.Keyboard_EqualsAndPlus, new int[] { 1, 12 } },
            { LedId.Keyboard_Backspace, new int[] { 1, 13 } },
            { LedId.Keyboard_Insert, new int[] { 1, 14 } },
            { LedId.Keyboard_Home, new int[] { 1, 15 } },
            { LedId.Keyboard_PageUp, new int[] { 1, 16 } },
            { LedId.Keyboard_NumLock, new int[] { 1, 17 } },
            { LedId.Keyboard_NumSlash, new int[] { 1, 18 } },
            { LedId.Keyboard_NumAsterisk, new int[] { 1, 19 } },
            { LedId.Keyboard_NumMinus, new int[] { 1, 20 } },

            { LedId.Keyboard_Tab, new int[] { 2, 0 } },
            { LedId.Keyboard_Q, new int[] { 2, 1 } },
            { LedId.Keyboard_W, new int[] { 2, 2 } },
            { LedId.Keyboard_E, new int[] { 2, 3 } },
            { LedId.Keyboard_R, new int[] { 2, 4 } },
            { LedId.Keyboard_T, new int[] { 2, 5 } },
            { LedId.Keyboard_Y, new int[] { 2, 6 } },
            { LedId.Keyboard_U, new int[] { 2, 7 } },
            { LedId.Keyboard_I, new int[] { 2, 8 } },
            { LedId.Keyboard_O, new int[] { 2, 9 } },
            { LedId.Keyboard_P, new int[] { 2, 10 } },
            { LedId.Keyboard_BracketLeft, new int[] { 2, 11 } },
            { LedId.Keyboard_BracketRight, new int[] { 2, 12 } },
            { LedId.Keyboard_Backslash, new int[] { 2, 13 } },
            { LedId.Keyboard_Delete, new int[] { 2, 14 } },
            { LedId.Keyboard_End, new int[] { 2, 15 } },
            { LedId.Keyboard_PageDown, new int[] { 2, 16 } },
            { LedId.Keyboard_Num7, new int[] { 2, 17 } },
            { LedId.Keyboard_Num8, new int[] { 2, 18 } },
            { LedId.Keyboard_Num9, new int[] { 2, 19 } },

            { LedId.Keyboard_CapsLock, new int[] { 3, 0 } },
            { LedId.Keyboard_A, new int[] { 3, 1 } },
            { LedId.Keyboard_S, new int[] { 3, 2 } },
            { LedId.Keyboard_D, new int[] { 3, 3 } },
            { LedId.Keyboard_F, new int[] { 3, 4 } },
            { LedId.Keyboard_G, new int[] { 3, 5 } },
            { LedId.Keyboard_H, new int[] { 3, 6 } },
            { LedId.Keyboard_J, new int[] { 3, 7 } },
            { LedId.Keyboard_K, new int[] { 3, 8 } },
            { LedId.Keyboard_L, new int[] { 3, 9 } },
            { LedId.Keyboard_SemicolonAndColon, new int[] { 3, 10 } },
            { LedId.Keyboard_ApostropheAndDoubleQuote, new int[] { 3, 11 } },
            { LedId.Keyboard_Enter, new int[] { 3, 13 } },
            { LedId.Keyboard_Num4, new int[] { 3, 17 } },
            { LedId.Keyboard_Num5, new int[] { 3, 18 } },
            { LedId.Keyboard_Num6, new int[] { 3, 19 } },
            { LedId.Keyboard_NumPlus, new int[] { 3, 20 } },

            { LedId.Keyboard_LeftShift, new int[] { 4, 0 } },
            { LedId.Keyboard_Z, new int[] { 4, 2 } },
            { LedId.Keyboard_X, new int[] { 4, 3 } },
            { LedId.Keyboard_C, new int[] { 4, 4 } },
            { LedId.Keyboard_V, new int[] { 4, 5 } },
            { LedId.Keyboard_B, new int[] { 4, 6 } },
            { LedId.Keyboard_N, new int[] { 4, 7 } },
            { LedId.Keyboard_M, new int[] { 4, 8 } },
            { LedId.Keyboard_CommaAndLessThan, new int[] { 4, 9 } },
            { LedId.Keyboard_PeriodAndBiggerThan, new int[] { 4, 10 } },
            { LedId.Keyboard_SlashAndQuestionMark, new int[] { 4, 11 } },
            { LedId.Keyboard_RightShift, new int[] { 4, 13 } },
            { LedId.Keyboard_ArrowUp, new int[] { 4, 15 } },
            { LedId.Keyboard_Num1, new int[] { 4, 17 } },
            { LedId.Keyboard_Num2, new int[] { 4, 18 } },
            { LedId.Keyboard_Num3, new int[] { 4, 19 } },

            { LedId.Keyboard_LeftCtrl, new int[] { 5, 0 } },
            { LedId.Keyboard_LeftGui, new int[] { 5, 1 } },
            { LedId.Keyboard_LeftAlt, new int[] { 5, 3 } },
            { LedId.Keyboard_Space, new int[] { 5, 6 } },
            { LedId.Keyboard_RightAlt, new int[] { 5, 10 } },
            { LedId.Keyboard_RightGui, new int[] { 5, 11 } },
            { LedId.Keyboard_Application, new int[] { 5, 12 } },
            { LedId.Keyboard_RightCtrl, new int[] { 5, 13 } },
            { LedId.Keyboard_ArrowLeft, new int[] { 5, 14 } },
            { LedId.Keyboard_ArrowDown, new int[] { 5, 15 } },
            { LedId.Keyboard_ArrowRight, new int[] { 5, 16 } },
            { LedId.Keyboard_Num0, new int[] { 5, 17 } },
            { LedId.Keyboard_NumPeriodAndDelete, new int[] { 5, 19 } },
            { LedId.Keyboard_NumEnter, new int[] { 5, 20 } }
