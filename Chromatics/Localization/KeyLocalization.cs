...
namespace Chromatics.Localization
{
    public static class KeyLocalization
    {
        public static List<KeyboardKey> GetLocalizedKeys(KeyboardLocalization locale)
        {
            ...
            switch (locale)
            {
                case KeyboardLocalization.None:
                    break;
                case KeyboardLocalization.intl:
                    break;
                case KeyboardLocalization.us:
                    break;
                case KeyboardLocalization.uk:
                    break;
                case KeyboardLocalization.ru:
                    break;
                case KeyboardLocalization.fr:
                    break;
                case KeyboardLocalization.de:
                    break;
                case KeyboardLocalization.jpn:
                    break;
                case KeyboardLocalization.tr:
                    break;
                case KeyboardLocalization.nordic:
                    break;
                case KeyboardLocalization.swiss:
                    break;
                case KeyboardLocalization.abnt2:
                    break;
                case KeyboardLocalization.dvorak:
                    break;
                case KeyboardLocalization.dvorak_int:
                    break;
                case KeyboardLocalization.hu:
                    break;
                case KeyboardLocalization.it:
                    break;
                case KeyboardLocalization.la:
                    break;
                case KeyboardLocalization.es:
                    break;
                case KeyboardLocalization.iso:
                    break;
                case KeyboardLocalization.ansi:
                    break;
                default:
                    break;
            }
        ...
        private static List<KeyboardKey> Default = new List<KeyboardKey>()
        {
