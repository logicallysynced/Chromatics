...
{
    public class BPMStarfieldDecorator : AbstractUpdateAwareDecorator, ILedGroupDecorator
    {
        ...
        public BPMStarfieldDecorator(ListLedGroup _ledGroup, int numberOfLeds, int bpm, double fadeSpeed, Color[] colors, RGBSurface surface, double densityMultiplier = 1.0, bool updateIfDisabled = false, Color baseColor = default(Color)) : base(surface, updateIfDisabled)
        {
