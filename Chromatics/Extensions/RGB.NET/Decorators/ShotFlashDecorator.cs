...
namespace Chromatics.Extensions.RGB.NET.Decorators
{
    ...
    /// </summary>
    public class ShotFlashDecorator : AbstractUpdateAwareDecorator, IBrushDecorator
    {
        ...
        public ShotFlashDecorator(RGBSurface surface, bool updateIfDisabled = false)
        ...
        protected override void Update(double deltaTime)
        {
            ...
            if (_currentPhase == ADSRPhase.Pause)
                ...
                else
                {
                    ...
                    {
                        foreach (AbstractBrush test in this.DecoratedObjects)
                        {
                            test.Opacity = 0;
                        }
